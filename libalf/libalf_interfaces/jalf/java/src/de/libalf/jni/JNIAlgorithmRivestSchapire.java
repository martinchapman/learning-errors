...
/**
 * <p>
 * Rivest and Schapire's learning algorithm for regular languages. See
 * <ul>
 * <li>
 * <em>R. Rivest and R. Schapire - Inference of finite automata using homing
 * sequences</em></li>
 * </ul>
 * </P>
 * 
 ...
 * 
 */
public class JNIAlgorithmRivestSchapire extends JNILearningAlgorithm {
	private static final long serialVersionUID = 2L;

	/**
	 * Creates a new object implementing Rivest and Schapire's learning algorithm.
	 * 
	 * @param knowledgebase
	 ...
	 */
	public JNIAlgorithmRivestSchapire(Knowledgebase knowledgebase, int alphabet_size) {
	 ...
	 * <code>rivest_shapire_table</code> object with the pointer to a
