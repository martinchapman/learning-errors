/* $Id: jni_algorithm_nlstar.cpp 1081 2009-11-11 16:33:40Z davidpiegdon $
 * vim: fdm=marker
 *
...
JNIEXPORT jlong JNICALL Java_de_libalf_jni_JNIAlgorithmNLstar_init__JI (JNIEnv *env, jobject obj, jlong knowledgebase_pointer, jint alphabet_size) {
...
JNIEXPORT jlong JNICALL Java_de_libalf_jni_JNIAlgorithmNLstar_init__JIJ (JNIEnv *env, jobject obj, jlong knowledgebase_pointer, jint alphabet_size, jlong logger_pointer) {
	// Get the knowledgebase object
	knowledgebase<bool> *base = (knowledgebase<bool>*) knowledgebase_pointer;
