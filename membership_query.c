...
#define _Learn_Neg if (_Learn_idx >= mq_length || _Learn_mq[_Learn_idx] != 0) assume(0); _Learn_b[_Learn_idx++] = 1   //take the negative branch; in while it corresponds to exiting the loop     
